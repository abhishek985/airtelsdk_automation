...
public class Htmlfilewriter {
	...
	public void write( BufferedWriter bw, int Native_Heap_Free ,int Total_Heap_Free , int Native_Heap_Alloc,
			int Native_Pss ,int Total_Heap_Alloc ,int Total_Pss)
	//,String CPU_0,
	...
	throws IOException {
		bw.write("\n" + 
				...
				"</style>\n" + 
				"\n" + 
				"<table id = \"datatable\" style = \"width: 550px; height: 40px; margin: 0 auto\">\n" + 
				"    <thead>\n" + 
				"    <tr>\n" + 
				"         <th>Scenario</th>\n" + 
				...
				"    <tr>\n" + 
				"        <th>login</th>\n" + 
				"        <td>"+Total_Heap_Free+"</td>\n" + 
				"        <td>"+Native_Heap_Free+"</td>\n" + 
				"        <td>"+Native_Heap_Alloc+"</td>\n" + 
				"        <td>"+Native_Pss+"</td>\n" + 
				"        <td>"+Total_Heap_Alloc+"</td>\n" + 
				"        <td>"+Total_Pss+"</td>\n" + 
				"        <!--</tr>-->\n" + 
				"        <!--<tr>-->\n" + 
				"        <!--<th>logout</th>-->\n" + 
